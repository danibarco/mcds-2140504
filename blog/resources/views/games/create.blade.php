        ...
        <form method="POST" action="{{ route('games.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" cols="30"
                    rows="4" placeholder="Descripción">{{ old('description') }}</textarea>
            ...
            <div class="form-group">
                <div class="text-center my-3">
                    <img src="{{ asset('imgs/no-photo.png') }}" class="img-thumbnail"
            ...
            <div class="form-group">
                <select name="category_id" class="form-control @error('category_id') is-invalid @enderror">
                    ...
                    @foreach($cats as $cat)
                        <option value="{{ $cat->id }}" @if ($cat->id == old('category_id')) selected
