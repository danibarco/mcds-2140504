                ...
                @foreach($games as $game)
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell">
                            <img src="{{ asset($game->category->photo) }}" width="36px">
                        </td>
                        <td><img src="{{ asset($game->photo) }}" width="36px"></td>
                        <td>
                            <a href="{{ url('games/'.$game->id) }}"
                                class="btn btn-sm btn-light"><i class="fa fa-search"></i></a>
                            <a href="{{ url('games/'.$game->id.'/edit') }}"
                                class="btn btn-sm btn-light"><i class="fa fa-pen"></i></a>
